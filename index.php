                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse" id="navbar-menu">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <? if($is_status) { ?>
                                    <a href="<?php echo $linklogout; ?>" class="btn btn-white-fill navbar-btn" >Đăng xuất</a>
                                <? }else if($is_logout){ ?>
                                    <a href="<?php echo $linklogin; ?>" class="btn btn-white-fill navbar-btn" >Đăng nhập</a>
                                <?}?>
                        ...
                        <div class="col-md-5 col-md-offset-1 col-sm-6">
                            <? if($is_status) { ?>
                                ...
                                <? }else if($is_logout) { ?>
                                    ...
                                    <strong>Tạm biệt <?php echo $username; ?></strong>
                                </div>
